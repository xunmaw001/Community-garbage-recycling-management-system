...
public class HuishouyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuishouyuanEntity user = huishouyuanService.selectOne(new EntityWrapper<HuishouyuanEntity>().eq("shangjiabianhao", username));
    ...
    public R register(@RequestBody HuishouyuanEntity huishouyuan){
    	...
    	HuishouyuanEntity user = huishouyuanService.selectOne(new EntityWrapper<HuishouyuanEntity>().eq("shangjiabianhao", huishouyuan.getShangjiabianhao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HuishouyuanEntity huishouyuan, 
		HttpServletRequest request){
        EntityWrapper<HuishouyuanEntity> ew = new EntityWrapper<HuishouyuanEntity>();
		PageUtils page = huishouyuanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, huishouyuan), params), params));
        return R.ok().put("data", page);
